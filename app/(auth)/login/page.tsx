      ...
      <div className="absolute inset-0 bg-[#0F172A] z-0">
        ...
        <div className="absolute inset-0 flex items-center justify-center opacity-5">
          <svg width="800" height="800" viewBox="0 0 800 800" fill="none">
            ...
            {/* Connection lines */}
            <line x1="400" y1="400" x2="250" y2="300" stroke="#4F46E5" strokeWidth="1" opacity="0.3" />
            <line x1="400" y1="400" x2="550" y2="300" stroke="#A855F7" strokeWidth="1" opacity="0.3" />
            <line x1="400" y1="400" x2="250" y2="500" stroke="#A855F7" strokeWidth="1" opacity="0.3" />
            <line x1="400" y1="400" x2="550" y2="500" stroke="#4F46E5" strokeWidth="1" opacity="0.3" />
            <line x1="400" y1="400" x2="400" y2="200" stroke="#22D3EE" strokeWidth="1" opacity="0.3" />
            <line x1="400" y1="400" x2="400" y2="600" stroke="#22D3EE" strokeWidth="1" opacity="0.3" />
          </svg>
        </div>
      </div>
        ...
        <div className="flex justify-center mb-8">
          <div className="flex items-center space-x-3">
            ...
            >
              ...
              <defs>
                <linearGradient id="loginGradient1" x1="0%" y1="0%" x2="0%" y2="100%">
                  <stop offset="0%" stopColor="#4F46E5" />
                  <stop offset="100%" stopColor="#22D3EE" />
                </linearGradient>
                <linearGradient id="loginGradient2" x1="0%" y1="0%" x2="0%" y2="100%">
