          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4">
            <div className="flex items-center justify-between">
              <div className="flex items-center gap-3">
                ...
                <div>
                  <h1 className="text-lg font-bold text-slate-100">Wallet Connection</h1>
                  <p className="text-xs text-slate-500">Secure blockchain authentication</p>
                </div>
              </div>
        ...
        <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
            ...
            <div className="lg:col-span-2 space-y-6">
              ...
              <div className="text-center lg:text-left">
                ...
                <p className="text-slate-400 leading-relaxed max-w-2xl">
                  Link your blockchain wallet to access your skill credentials, mint new achievements, 
                  and manage your decentralized identity on SkillFlow.
                </p>
              </div>
                ...
                <div className="p-4 rounded-xl bg-red-500/10 border border-red-500/30 backdrop-blur-sm">
                  <div className="flex items-start gap-3">
                    ...
                    <div className="flex-1">
                      ...
                      {error.suggestion && (
                        <p className="text-xs text-red-300/70 mt-1">{error.suggestion}</p>
                      )}
                    </div>
                  </div>
                </div>
              ...
              {connectionStatus === Status.Disconnected && availableProviders && (
                <div className="space-y-4">
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                    {availableProviders
                      .filter(p => p.name === WalletProvider.MetaMask || p.name === WalletProvider.WalletConnect)
                      .map((provider) => (
                        <WalletProviderButton
                          key={provider.id}
                          provider={provider}
                          onConnect={handleProviderSelect}
                          disabled={loading || connectionStatus !== Status.Disconnected}
                        />
                      ))}
                  </div>
                  ...
                  <div className="mt-6 p-4 rounded-xl bg-blue-500/10 border border-blue-500/20 backdrop-blur-sm">
                    <div className="flex items-start gap-3">
                      ...
                      <div className="flex-1">
                        <h4 className="text-sm font-semibold text-blue-300 mb-1">First time connecting?</h4>
                        <p className="text-sm text-blue-200/80 leading-relaxed">
                          ...
                          {' '}for beginners. It's free, secure, and easy to set up.
                        </p>
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="p-6 rounded-2xl bg-gradient-to-br from-slate-900/90 to-slate-800/90 border border-slate-700/50 backdrop-blur-xl shadow-2xl">
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                      <div className="p-3 rounded-lg bg-slate-800/50 border border-slate-700/50">
                        ...
                        <p className="text-sm font-semibold text-slate-200">{connectedWallet.provider}</p>
                      </div>
                      <div className="p-3 rounded-lg bg-slate-800/50 border border-slate-700/50">
                        <p className="text-xs text-slate-500 mb-1">Network</p>
                        <p className="text-sm font-semibold text-slate-200">{connectedWallet.network.name}</p>
                      </div>
            ...
            <div className="lg:col-span-1">
              <SafetySidebar 
                currentStep={connectionProgress?.currentStep || ConnectionStep.Idle}
                tips={safetyTips}
              />
            </div>
          </div>
