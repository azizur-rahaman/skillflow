...
import {
  ...
  useVerification,
} from "@/features/verification/context/VerificationContext";
  ...
  return (
    <div className="min-h-screen bg-slate-950">
      ...
      <main className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
          ...
          <div className="max-w-2xl mx-auto">
            <div className="text-center mb-8">
              ...
              <p className="text-slate-400 leading-relaxed max-w-lg mx-auto">
                Enter a credential token ID or verification URL to check its
                authenticity on the blockchain. This verification is public and
            ...
            <div className="mt-8 p-6 bg-slate-900/50 backdrop-blur-sm border border-slate-700/50 rounded-xl">
              ...
              <ul className="space-y-3">
                <li className="flex items-start gap-3 text-sm text-slate-400">
                  ...
                  <span>
                    Credential exists on blockchain and hasn&apos;t been revoked
                  </span>
                </li>
                <li className="flex items-start gap-3 text-sm text-slate-400">
                  <svg
                  ...
                  <span>
                    Issuer is verified and trusted on the SkillFlow platform
                  </span>
                </li>
                <li className="flex items-start gap-3 text-sm text-slate-400">
                  <svg
                  ...
                  <span>
                    Cryptographic signature matches the credential data
                  </span>
                </li>
                <li className="flex items-start gap-3 text-sm text-slate-400">
                  <svg
        ...
        {verificationState === VerificationState.Validating &&
          validationProgress && (
            <div className="max-w-2xl mx-auto">
              <div className="text-center mb-8">
              ...
              <BlockchainValidation progress={validationProgress} animated />
            </div>
          )}
        ...
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
          <div className="text-center">
            <p className="text-sm text-slate-500 mb-2">
              Powered by blockchain technology for secure and verifiable
              credentials
            </p>
